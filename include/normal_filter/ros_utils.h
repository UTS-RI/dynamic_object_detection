...
inline sensor_msgs::PointCloud2 ptsVecToPointCloud2MsgInternal(const std::vector<Point>& pts, const std::string& frame_id, const ros::Time& time)
{
...
inline sensor_msgs::PointCloud2 ptsVecToPointCloud2MsgInternal(const std::vector<Point>& pts, const std_msgs::Header& header)
{
...
template <typename T>
inline std::tuple<std::vector<PointTemplated<T> >, bool> pointCloud2MsgToPtsVec(const sensor_msgs::PointCloud2ConstPtr& msg, const double time_scale = 1e-9, const bool need_time = true)
{
...
inline sensor_msgs::PointCloud2 cloudAndScoreToRosMsg(const std::vector<Pointf>& pts, const std::vector<float>& scores, const std_msgs::Header& header)
{
